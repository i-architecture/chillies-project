...
public class StringUtilTest {
    ...
    public void trim1() {
        ...
        strs = new String[]{" ", "\t"};
        assertArrayEquals(StringUtil.trim(strs), new String[]{"", ""});

        strs = new String[]{" abc", "edf\t"};
        assertArrayEquals(StringUtil.trim(strs), new String[]{"abc", "edf"});

        strs = new String[]{" java ", "\ta c"};
        assertArrayEquals(StringUtil.trim(strs), new String[]{"java", "a c"});
    ...
    public void split() {
        ...
        assertArrayEquals(array, new String[]{"hello a", "everything", "will", "be", "ok"});
        System.out.println(str + "\t->\t\t" + Arrays.toString(array));
        ...
        assertNotNull(array);
        assertEquals(array.length, 5);
        assertArrayEquals(array, new String[]{"Best", "wish", "for", "you", "Thanks."});
        System.out.println(str + "\t->\t\t" + Arrays.toString(array));
        ...
        assertArrayEquals(array, new String[]{"Mac", "iPad#iPad Pro", "iPhone"});
        System.out.println(str + "\t->\t\t" + Arrays.toString(array));
        ...
        assertNotNull(array);
        assertEquals(array.length, 3);
        assertArrayEquals(array, new String[]{"筷子", "笔记", "随|便"});
        System.out.println(str + "\t->\t\t" + Arrays.toString(array));
    }
