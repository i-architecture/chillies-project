...
public class Patterns {
     ...
     * 车牌号(新能源+非新能源)
     */
    public static final Pattern PLATE_CODE = Pattern.compile("^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领][A-HJ-NP-Z][A-HJ-NP-Z0-9]{4,5}[A-HJ-NP-Z0-9挂学警港澳]$");
     ...
     * 身份证号(1代,15位数字)
     */
    public static final Pattern IDENTITY_NUMBER_15 = Pattern.compile("^[1-9]\\d{7}(?:0\\d|10|11|12)(?:0[1-9]|[1-2][\\d]|30|31)\\d{3}$");

    /**
     * 身份证号(2代,18位数字),最后一位是校验位,可能为数字或字符X
     */
    public static final Pattern IDENTITY_NUMBER_18 = Pattern.compile("^[1-9]\\d{5}(?:18|19|20)\\d{2}(?:0[1-9]|10|11|12)(?:0[1-9]|[1-2]\\d|30|31)\\d{3}[\\dXx]$");

    /**
     * 身份证号, 支持1/2代(15位/18位数字)
     */
    public static final Pattern IDENTITY_NUMBER = Pattern.compile("(^\\d{8}(0\\d|10|11|12)([0-2]\\d|30|31)\\d{3}$)|(^\\d{6}(18|19|20)\\d{2}(0[1-9]|10|11|12)([0-2]\\d|30|31)\\d{3}(\\d|X|x)$)");
     ...
     */
    @NotNull
    public static Pattern get(@NotNull String regex) {
        return get(regex, 0);
    }
     ...
     */
    @NotNull
    public static Pattern get(@NotNull String regex, int flags) {
     ...
     */
    @Nullable
    public static Pattern remove(@NotNull String regex, int flags) {
    ...
    private static class RegexWithFlags {
        ...
        private RegexWithFlags(@NotNull String regex, int flags) {
            this.regex = regex;
            this.flags = flags;
        }
