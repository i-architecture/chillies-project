...
import com.ijiagoushi.chillies.core.exceptions.DecoderRuntimeException;
...
public class HexUtil {
    ...
    public static char[] encode(final byte[] data, final boolean toLowerCase) {
        return doEncode(Preconditions.requireNonNull(data), toLowerCase ? DIGITS_LOWER : DIGITS_UPPER);
    }
    ...
    public static String decodeToStr(final String data, final Charset outputEncoding) {
        ...
        return new String(decode, CharsetUtil.getCharset(outputEncoding));
    }
    ...
    public static byte[] decode(final String data) {
        return decode(Preconditions.requireNonNull(data).toCharArray());
    }
