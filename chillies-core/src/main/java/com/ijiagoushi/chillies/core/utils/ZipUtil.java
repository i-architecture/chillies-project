...
import com.ijiagoushi.chillies.core.exceptions.ZipException;
...
public class ZipUtil {
     ...
     * @param srcFiles 源文件路径
     */
    public static void zip( File zipFile,  Charset charset,  File... srcFiles) {
     ...
     */
    public static void zip( File zipFile,  Charset charset, boolean withSrcDir,  File... srcFiles) {
     ...
     * @param srcFiles   要压缩的源文件或目录。如果压缩一个文件，则为该文件的全路径；如果压缩一个目录，则为该目录的顶层目录路径
     */
    public static void zip( File zipFile,  Charset charset, boolean withSrcDir,
                            FileFilter filter,  File... srcFiles) {
