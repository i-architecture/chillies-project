...
public class ClassUtil {
     ...
     */
    @Nullable
    public static <T> Class<T> getClass(@Nullable T obj) {
    ...
    public static Class<?>[] getClasses(Object... values) {
        return Arrays.stream(Preconditions.requireNonNull(values))
    ...
    public static Object getDefaultValue(Class<?> clazz) {
        if (Preconditions.requireNonNull(clazz).isPrimitive()) {
    ...
    public static Object[] getDefaultValues(Class<?>[] parameterTypes) {
        return Arrays.stream(Preconditions.requireNonNull(parameterTypes))
    ...
    public static boolean isStatic(Method method) {
        return Modifier.isStatic(Preconditions.requireNonNull(method, "method == null").getModifiers());
    }
