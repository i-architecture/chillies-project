...
import com.ijiagoushi.chillies.core.convert.ConverterRegistry;
...
import com.ijiagoushi.chillies.http.HttpFormBody;
import com.ijiagoushi.chillies.http.HttpMultipartBody;
...
public class BaseBodyRequest<Req extends BaseBodyRequest<Req>> extends AbstractBaseRequest<Req> {
    ...
    public Req json(String json) {
        Preconditions.requireNonNull(json, "json == null");
    ...
    public Req text(String text) {
        Preconditions.requireNonNull(text, "text == null");
    ...
    public Req xml(String xml) {
        Preconditions.requireNonNull(xml, "xml == null");
    ...
    public Req html(String html) {
        Preconditions.requireNonNull(html, "html == null");
    ...
    public Req javascript(String javascript) {
        Preconditions.requireNonNull(javascript, "javascriptc == null");
    ...
    private void processParam(String name, Object value) {
        if (value != null) {
            if (value instanceof File) {
                ...
                this.params.put(name, ConverterRegistry.getInstance().convert(value, String.class));
            }
        }
    }
