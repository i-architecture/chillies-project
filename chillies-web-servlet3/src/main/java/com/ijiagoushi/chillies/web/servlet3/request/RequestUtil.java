package com.ijiagoushi.chillies.web.servlet3.request;
...
public final class RequestUtil {
     ...
     * @return 目标对象
     */
    public static <T> T read2Bean(@NotNull HttpServletRequest request, Class<T> clazz) {
     ...
     * @return 目标对象
     */
    public static <T> T read2Bean(@NotNull HttpServletRequest request, TypeRef<T> typeRef) {
        String body = read2Bean(request);
     ...
     * @return body的内容
     */
    public static String read2Bean(@NotNull HttpServletRequest request) {
